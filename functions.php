...
function mytheme_page_templates( $templates ) {
	$templates['templates/template-home.php']      = 'Home Page';
 ...
 *
 * This function registers all custom blocks defined in the theme.
 * Each block folder should contain a `block.json` and a `render.php`.
 *
 * @return void
 */
